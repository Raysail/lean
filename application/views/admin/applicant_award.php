                    ...
                    <div class="row">
						...
						<div class="box-body">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- form start -->
                                <form role="form" method="post" name="content_frm" id="content_frm" action="<?php echo base_url();?>admin/funding/award_action" enctype="multipart/form-data" onsubmit="return check_from();" > 
								...
								<input type="hidden"  name="fund_new_status" id="fund_new_status" value="<?php echo $fund_new_status;?>" />
										...
										<table cellpadding="5" cellspacing="5" width="100%">
											<tr>
												...
												<td valign="top" align="left"><?php echo $fdata[0]->fund_title;?><br /><br />
													...
													Evaluation: <?php echo date('m-d-Y',strtotime($fdata[0]->fund_update));?>
												</td>
											</tr>
											<tr>
											...
											<tr>
												<td  colspan="2">Persons Awarded</td>
											</tr>
											<tr>
												<td colspan="2">
												<?php
												if(!empty($applicant_data)){
													foreach($applicant_data as $app_list){
													?>
										<input type="checkbox" name="applicant_awarded[]" id="applicant_awarded" value="<?php echo $app_list->app_id;?>" />			
													<?php echo $app_list->app_name;?><br />
													
												<?php }
												}
												?>
												<!--<textarea class="form-control" name="applicant_awarded" id="applicant_awarded" required="required"></textarea>-->
                                    ...
                                    <div class="box-footer">
                                        <button type="submit" class="btn btn-primary" name="cat_button" value="<?php echo $but_value?>">Send to applicant</button>
                                    </div>
                                </form>
                            </div><!-- /.box -->
