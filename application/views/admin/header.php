...
<link id="bsdp-css" href="<?php echo base_url();?>design/admin/css/datepicker.css" rel="stylesheet">	
 <script src="<?php echo base_url();?>design/admin/js/bootstrap-datepicker.js"></script>
   <script> 
    $(function($) {
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview <?php if(($this->uri->segment(2) == 'articletype-list')  ||  ($this->uri->segment(2) == 'articletype-form')||($this->uri->segment(2) == 'articlesubmi-list')|| ($this->uri->segment(2)=='articlesubmi-form')|| ($this->uri->segment(2)=='fund-list')|| ($this->uri->segment(2)=='fund-form')|| ($this->uri->segment(2)=='applicant-message')|| ($this->uri->segment(2)=='funding-detail')|| ($this->uri->segment(2)=='fund-awarded')||  ($this->uri->segment(2)=='applicant-message')){echo 'active';}?>">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php  echo base_url();?>administrator/fund-list"><i class="fa fa-angle-double-right"></i>Funding</a></li>
