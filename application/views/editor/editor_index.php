                        ...
                        <div class="tab-content new_tab_fullwidth">
							...
							<?php if(!empty($in_submit))
								...
								<tr>
								  ...
								  <a href="<?php echo base_url().'editor_view_project/'.$submit_list->art_no;?>" style="font-weight:normal !important;"><strong><?php echo word_limiter($submit_list->art_fulltitle,5);?></strong></a>
								  	<?php }else{?>
							  ...
							  <div class="tab_one_sec public_n">
								...
								<?php if(!empty($in_review))
									...
									<tr>
									  ...
									  <a href="<?php echo base_url().'editor_view_project/'.$submit_list->art_no;?>" style="font-weight:normal !important;"><?php echo word_limiter($submit_list->art_fulltitle,5);?></a>
									  ...
									  <a href="<?php echo base_url().'editor_view_project/'.$submit_list->art_no;?>" style="font-weight:bold !important;color:#000000!important;"><?php echo word_limiter($submit_list->art_fulltitle,20);?></a>
										<?php }else{?>
									  <a href="<?php echo base_url().'editor_view_project/'.$submit_list->art_no;?>" style="color:#000 !important;"><?php echo word_limiter($submit_list->art_fulltitle,5);?></a>
										<?php }?>
									  </th>
									  <td><?php echo $submit_list->user_fname.'&nbsp'.$submit_list->user_lname;?></td>
                          ...
                          <div class="tab_one_sec public_n">
                      		  <?php if(!empty($in_proof))
									...
									<tr>
									  ...
									  <th>
										<?php if($count_message==0){?>
									  <a href="<?php echo base_url().'editor_view_project/'.$proof_list->art_no;?>" style="font-weight:normal !important;"><?php echo word_limiter($proof_list->art_fulltitle,5);?></a>
										<?php }else{?>
									  <a href="<?php echo base_url().'editor_view_project/'.$proof_list->art_no;?>" style="color:#000 !important;"><?php echo word_limiter($proof_list->art_fulltitle,5);?></a>
										<?php }?>
									  </th>
                          ...
                          <div class="tab_one_sec public_n">
                      		  ...
                      		  <?php if(!empty($in_complte))
									...
									<tr>
									  ...
									  <th>
										<?php if($count_message==0){?>
									  <a href="<?php echo base_url().'editor_view_project/'.$complete_list->art_no;?>" style="font-weight:normal !important;"><?php echo word_limiter($complete_list->art_fulltitle,5);?></a>
										<?php }else{?>
									  <a href="<?php echo base_url().'editor_view_project/'.$complete_list->art_no;?>" style="color:#000 !important;"><?php echo word_limiter($complete_list->art_fulltitle,5);?></a>
										<?php }?>
									  </th>
                           ...
                           <div class="tab_one_sec public_n">
								...
								<tr>
								  ...
								  <tbody>
									...
									<tr>
                                  <th>
								  <a href="<?php echo base_url().'editor_view_project/'.$decline_list->art_no;?>" style="font-weight:normal !important;"><?php echo word_limiter($decline_list->art_fulltitle,5);?></a></th>
