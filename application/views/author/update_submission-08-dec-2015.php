					   ...
					   <div>
                        ...
                        <div class="col-md-4">
						 ...
						 <div id="user_data">
							...
							<div class="col-md-2">
							  <div class="tab_two_sec_buttom">
								<p class="sec_active"><input type="text" name="frnd_position[]" id="frnd_position" value="<?php echo $invite_list->frnd_posit;?>"/></p>
							  </div>
							</div>
							<div class="col-md-2">
							  <div class="tab_two_sec_buttom">
							...
							<div class="col-md-4">
							  <div class="tab_two_sec_buttom">
								<p class="sec_active"><input type="text" name="frnd_info[]" id="frnd_info" value="<?php echo $invite_list->frnd_info;?>"/></p>
							  </div>
							</div>
