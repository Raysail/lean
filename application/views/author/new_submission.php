...
<div class="main_content">
							...
							<div class="col-md-4">
							  <div class="tab_two_sec_buttom">
								...
								<div class="select_left" id="all_sel_exp<?php echo $ij;?>">
								 ...
								 <button type="button" class="btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm<?php echo $ij;?>" data-no="<?php echo $ij;?>">Choose</button>
								 </p>
							  </div>
							</div>
 ...
 <input class="inner_check_fend"  name="sub_frnd_expt" id="sub_frnd_exp-<?php echo $classi->asubmi_id; ?>" data-parentid="<?php echo $classi->asubmi_id; ?>" data-loopno="<?php echo $ij;?>" data-name="<?php echo $classi->asubmi_title; ?>" type="checkbox" value="<?php echo $classi->asubmi_id; ?>">&nbsp;&nbsp; <?php echo $classi->asubmi_title; ?></label>
 <br>
 <?php	}	?>
    </div>
  </div>
