            ...
            <div class="panel with-nav-tabs panel-primary">
                ...
                <div class="panel-body">
                    <div class="tab-content" style="text-align:left">
						...
						<?php 
if(!(empty($article_data->art_cover_r) && empty($article_data->art_menuscript_r) && empty($article_data->art_figure_r) && empty($article_data->art_slide_r) && empty($article_data->art_supple_r) && empty($article_data->art_response_r))){
$art_cover = (!empty($article_data->art_cover_r))?$article_data->art_cover_r:$article_data->art_cover; 
$art_menuscript = (!empty($article_data->art_menuscript_r))?$article_data->art_menuscript_r:$article_data->art_menuscript; 
$art_figure = (!empty($article_data->art_figure_r))?$article_data->art_figure_r:$article_data->art_figure; 
$art_slide = (!empty($article_data->art_slide_r))?$article_data->art_slide_r:$article_data->art_slide; 
$art_supple = (!empty($article_data->art_supple_r))?$article_data->art_supple_r:$article_data->art_supple; 
$art_response = (!empty($article_data->art_response_r))?$article_data->art_response_r:$article_data->art_response; 
							  if(!empty($art_cover) ||
							...
							<p><?php if(!empty($art_cover)){?>
								<a target="_blank"  href="<?php echo base_url().'upload/article/author-'.$article_data->art_userid.'/'.$art_cover; ?>" > Cover letter</a>
								<?php } ?>
							</p>
							
							<p><?php if(!empty($art_menuscript)){?>
								<a target="_blank"  href="<?php echo base_url().'upload/article/author-'.$article_data->art_userid.'/'.$art_menuscript;?>">Manuscript</a>
								<?php } ?>
							</p>
							<p><?php if(!empty($art_figure)){?>
								<a target="_blank"  href="<?php echo base_url().'upload/article/author-'.$article_data->art_userid.'/'.$art_figure; ?>" > Fighre & Table</a>
								<?php } ?>
							</p>			
							<p><?php if(!empty($art_slide)){?>
								<a target="_blank"  href="<?php echo base_url().'upload/article/author-'.$article_data->art_userid.'/'.$art_slide; ?>" > Powerpoint Slide</a>
								<?php } ?>
							</p>			
							<p><?php if(!empty($art_supple)){?>
								<a target="_blank"  href="<?php echo base_url().'upload/article/author-'.$article_data->art_userid.'/'.$art_supple; ?>" >Supplementary</a>
								<?php } ?>
							</p>			
							<p><?php if(!empty($art_response)){?>
								<a target="_blank"  href="<?php echo base_url().'upload/article/author-'.$article_data->art_userid.'/'.$art_response; ?>" >  Response to Reviewer</a>
								<?php } ?>
							</p>
								<?php } else{ ?>
								Review
