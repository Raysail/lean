...
$(document).on('blur', '#user_email', function(){ 
	...
	var email=$('#user_email').val();
	  ...
	  data = 'email='+email;
		url =  "<?php echo base_url()?>general_login/check_unique_email";
		$.ajax({
				   type: "POST",
				   url: url,
				   data: data,
        ...
        <div class="row">
          <div class="main_registation_sec">
        	...
        	<?php if($this->session->flashdata('success')){echo  '<div class="alert alert-success" role="alert">'.$this->session->flashdata('success').'</div>';} ?>
              ...
              <form id="msform" action="<?php echo base_url();?>general_login/sign_up_action" method="post">
                <!-- progressbar -->
                <ul id="progressbar">
                ...
                <fieldset>
                  ...
                  <input type="email" name="user_email" id="user_email" placeholder="Email address" required="required"/>
                ...
                <fieldset>
                  ...
                  <input type="text" id="user_fname" name="user_fname" placeholder="First Name"  required="required"/>
                  <input type="text" id="user_lname" name="user_lname" placeholder="Last Name"  required="required"/>
                  <input type="text" id="user_instiute" name="user_instiute" placeholder="Institution" required="required"/>
                  <textarea name="user_address" id="user_address" required="required" class="form-control"  placeholder="Address"></textarea>
                ...
                <fieldset>
				  ...
				  <input type="hidden" name="user_classification" id="user_classification" value="" required />
...
<div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
 ...
 <input class="inner_check" name="user_expt" id="user_expt_<?php echo $classi->asubmi_id; ?>" data-parentid="<?php echo $classi->asubmi_id; ?>" data-name="<?php echo $classi->asubmi_title; ?>" type="checkbox" value="<?php echo $classi->asubmi_id; ?>"><label for="cb6" class="inner_cont_box"><?php echo $classi->asubmi_title; ?></label>
 <?php	}	?>
    </div>
  </div>
</div>
...
<div class="rgstrsn-line">
            ...
            <div class="onoffswitch">
                    <input type="checkbox"  name="user_reviewer" class="onoffswitch-checkbox" id="myonoffswitch" checked>
