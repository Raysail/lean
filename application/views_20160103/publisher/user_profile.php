...
<div class="main_content">
      <div class="container">
        <div class="row">
			<?php  $this->load->view('publisher/publisher_header');?>
        	...
        	<?php if($this->session->flashdata('success')){echo  '<div class="alert alert-success" role="alert">'.$this->session->flashdata('success').'</div>';} ?>
			  ...
			  <input type="hidden"  name="user_id" id="user_id" value="<?php echo $user_info[0]->user_id;?>" />
                ...
                <fieldset>
                  ...
                  <input type="text" id="user_fname" name="user_fname" value="<?php echo $user_info[0]->user_fname;?>"   required="required"/>
                  <input type="text" id="user_lname" name="user_lname" value="<?php echo $user_info[0]->user_lname;?>"  required="required"/>
                  <input type="text" id="user_instiute" name="user_instiute" value="<?php echo $user_info[0]->user_instiute;?>"  required="required"/>
                  <textarea name="user_address" id="user_address" required="required" class="form-control"><?php echo $user_info[0]->user_address;?></textarea>
