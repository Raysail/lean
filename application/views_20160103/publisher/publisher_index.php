                        ...
                        <div class="tab-content new_tab_fullwidth">
                          ...
                          <div class="tab_one_sec public_n">
                      		  <?php if(!empty($in_proof))
									...
									<tr>
									  ...
									  <a href="<?php echo base_url().'publisher_view_project/'.$proof_list->art_no;?>" style="font-weight:normal !important;"><?php echo word_limiter($proof_list->art_fulltitle,20);?></a>
										<?php }else{?>
									  <a href="<?php echo base_url().'publisher_view_project/'.$proof_list->art_no;?>" style="color:#000 !important;"><strong><?php echo word_limiter($proof_list->art_fulltitle,20);?></strong></a>
										<?php }?>
									  </th>
                          ...
                          <div class="tab_one_sec public_n">
									...
									<tr>
									  ...
									  <th>
										<?php if($count_message==0){?>
									  <a href="<?php echo base_url().'publisher_view_project/'.$comp_list->art_no;?>" style="font-weight:normal !important;"><?php echo word_limiter($comp_list->art_fulltitle,20);?></a>
										<?php }else{?>
									  <a href="<?php echo base_url().'publisher_view_project/'.$comp_list->art_no;?>" style="color:#000 !important;"><strong><?php echo word_limiter($comp_list->art_fulltitle,20);?></strong></a>
										<?php }?>
									  </th>
