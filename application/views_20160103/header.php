            ...
            <div class="main_nav">
              ...
              <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                  <li><a href="<?php echo base_url();?>"><i class="fa fa-file-archive-o"></i> Article ASAP</a></li>
                  <li><a href="<?php echo base_url().'archive-list';?>"><i class="fa fa-database"></i> Archive</a></li>
                  <li>
				  <?php 
				  $link ='';
          ...
          <div class="modal-content new_ser">
            ...
            <div class="modal-body">
              <div class="input-group new_search">
                <input type="text" class="form-control ser_sec" name="search_art" id="search_art" placeholder="Search for..." required="required">
