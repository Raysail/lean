            ...
            <div class="authr-dshbrd-right">
                ...
                <div class="authr-dsbrd-btn">
                	<div class="sbmsn-box">
						...
						if(($article_data[0]->art_status==7)){ echo 'In Revission';}?></a>
                    </div>
    ...
    <div class="col-md-12">
    	...
    	<div class="authr-nwsfeed-box">
        	<div class="au-nwsfeed-hed">
				...
				if($art_for=='required-revission'){ echo 'Revission Manuscript';$button_title ='Send back to author';$script_type ='back';}
