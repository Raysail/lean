<div class="wlcm-user-box">
          ...
          <div class="col-md-8">
          	<div class="usrprfl-menu">
            	<ul>
                	<li <?php if(($this->uri->segment(1)!='update-editor-profile')||($this->uri->segment(1)!='update-password')){ echo 'class="active"';}?> ><a href="<?php echo base_url();?>user-dashboard">Dashboard</a></li>
                    <li <?php if($this->uri->segment(1)=='update-editor-profile'){ echo 'class="active"';}?> ><a href="<?php echo base_url();?>update-editor-profile">Edit Profile</a></li>
